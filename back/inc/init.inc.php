...
//définir le chemin absolu du site (comme dans wordpress)
define('RACINE_SITE', '/andreePortfolio/back/');   // cette constante servira à créer les URL ou chemins absolus utilisés dans haut.inc.php car ce fichier sera inclus dans des scripts qui se situent dans des dossiers différents du site. On ne peut donc pas fair e de chemin relatif dans ce fichier.
